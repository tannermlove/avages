#' Youngest professor/lecturer at Williams College
#'
#' Returns the name(s) and age of the youngest professor/lecturer(s) at Williams college in a year from 2004 to 2014.
#'
