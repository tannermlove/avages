...
- \rhead{AVAGES}
vignette: |
  %\VignetteIndexEntry{Using the avages package} %\VignetteEngine{knitr::rmarkdown} \usepackage[utf8]{inputenc}
---
```{r, echo = FALSE}
